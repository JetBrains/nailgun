...
public class NGConstants {
  ...
  /** Loads the version number from a file generated by sbt. */
  private static String getVersion() {
    return Optional.ofNullable(NGConstants.class.getPackage().getImplementationVersion()).orElse("[DEVELOPMENT VERSION]");
  }
}
